...
COPY target/empirefx-gava-connect-0.0.1-SNAPSHOT.jar /usr/src/app/empirefx-gava-connect-0.0.1-SNAPSHOT.jar

# Set environment variables (optional)
ENV JAVA_OPTS=""

# Command to run the JAR file
ENTRYPOINT ["sh", "-c", "java $JAVA_OPTS -jar /usr/src/app/empirefx-gava-connect-0.0.1-SNAPSHOT.jar"]
